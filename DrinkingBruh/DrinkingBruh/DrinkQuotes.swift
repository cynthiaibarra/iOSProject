...
class DrinkQuotes {
    ...
    init() {
        ...
        quotes.append(["author" : "John Milton", "quote": "One sip of this will bathe the drooping spirits in delight, beyond the bliss of dreams."])
        quotes.append(["author" : "N.F. Simpson", "quote": "Reality is an illusion created by a lack of alcohol."])
        ...
        quotes.append(["author" : "Frantois Rabelais", "quote": "When I drink, I think; and when I think, I drink."])
